    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[45%] sidebar-bg border-r border-border p-12">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display text-xl font-bold tracking-tight text-foreground">Vault</span>
        </div>

        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20">
            <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
            <span className="text-xs font-medium text-primary">Self-hosted finance</span>
          </div>
          ...
          <p className="text-base text-muted-foreground leading-relaxed max-w-sm">
            Import your bank statements, categorize spending, and understand exactly where your money goes — all in one place.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm animate-fade-up">
          ...
          <div className="flex items-center gap-2.5 mb-10 lg:hidden">
            ...
            <span className="font-display text-lg font-bold text-foreground">Vault</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" disabled={isLoading} className="w-full h-10 font-semibold gap-2">
              {isLoading ? (
